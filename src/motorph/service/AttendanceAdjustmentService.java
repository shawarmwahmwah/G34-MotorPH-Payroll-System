    ...
    public boolean approveRequest(String requestId, Employee approver, String remarks) {
        ...
        for (AttendanceAdjustmentRequest request : requests) {
            ...
            if (attendanceDate == null) {
                lastMessage = "Request date format is invalid. Cannot apply adjustment.";
                return false;
            }
            ...
            if (!attendanceUpdated) {
                lastMessage = "Failed to update employee attendance record.";
                return false;
            }
            ...
            activityLogRepository.log(
                    ...
                    "Updated attendance of employee " + request.getEmployeeId()
                            + " for " + attendanceDate.format(CSV_DATE_FMT)
                            + " using request " + requestId
            );
